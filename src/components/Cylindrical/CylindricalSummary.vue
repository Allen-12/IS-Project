      ...
      <v-row dense>
        <v-col cols="6">
           <v-card
            ...
            <v-card-subtitle class="text-h6 font-weight-bold white--text">{{ diameter.toLocaleString({maximumFractionDigits:2}) }}</v-card-subtitle>
          </v-card>
        </v-col>
        <v-col cols="6">
           <v-card
            ...
            <v-card-subtitle class="text-h6 font-weight-bold white--text">{{ surfaceArea.toLocaleString({maximumFractionDigits:2}) }}</v-card-subtitle>
          </v-card>
        </v-col>
      </v-row>
  </v-container>
